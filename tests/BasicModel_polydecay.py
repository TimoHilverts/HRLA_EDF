...
def poly_schedule(k, K, h0=1e-4, alpha=0.35):
...
if __name__ == "__main__":
    ...
    algorithm = GO.HRLA(
    d=d, M=50, N=1, K=10000, h=poly_schedule,
    title=title, U=U_z, dU=dU_z, initial=initial,
    )

    samples_filename = algorithm.generate_samples(As=[0.1, 0.5, 1, 5], sim_annealing=True)
