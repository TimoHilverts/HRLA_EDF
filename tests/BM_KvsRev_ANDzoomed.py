...
if __name__ == "__main__":
    ...
    samples_filename = algorithm.generate_samples(As=[1, 5, 10, 20, 40], sim_annealing=True)
    postprocessor = PostProcessor(samples_filename)

    postprocessor.plot_running_best_revenue_all(dpi=500)
    postprocessor.plot_running_best_revenue_zoom_only(dpi=500, zoom_K=10000)