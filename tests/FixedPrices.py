...
# ============================================================
# EXTENSION: Single Competitor Baseline
...
shift = 0.0 # Baseline: no shifting
...
# ============================================================
# SINGLE Competitor (Static Environment)
# ============================================================
...
# Optimization
# ============================================================
title = "Baseline_SingleComp_FixedFees_RetailerFixedFees_Numpy"
d = 5
...
if __name__ == "__main__":
    ...
    print(f"\nStarting Optimization (M=100, K=50000, 5 parameters, Comp Fixed Fee={F_A})")
