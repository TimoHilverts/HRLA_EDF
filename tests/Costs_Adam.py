...
# Explicit Cost Structure (matching HRLA)
C_DAY   = 0.29
C_NIGHT = 0.21
C_GREEN = 0.010
C_SERVE = 110.0
...
# ============================================================
# PROFIT & ANALYTIC GRADIENT (in z-space, matching HRLA)
# ============================================================
def profit_and_grad(z):
    ...
    # Chain rule: gradient in z-space
    grad_z *= SCALE
...
# ADAM OPTIMIZER
# ============================================================
def run_adam(M=10, K=10000, lr_init=0.02, beta1=0.9, beta2=0.999, eps=1e-8):
    all_best_profits = []
    ...
    for m in range(M):
        ...
        for k in range(1, K + 1):
            lr = lr_init * (1.0 - k / K)  # Linear decay matching HRLA annealing spirit
        ...
        all_best_profits.append(run_best_p)

    total_time = time.perf_counter() - start_t

    print("\n" + "=" * 50)
    print("ADAM BENCHMARK RESULTS")
    print("-" * 50)
