...
if __name__ == "__main__":
    ...
    algorithm = GO.HRLA(
        d=d, M=100, N=1, K=50000, h=0.000001,
    ...
    # measured = [1, 100, 500, 1000, 5000, 10000, 20000, 30000, 40000, 50000]
    
    
    #postprocessor.compute_tables(measured, 1, "best")
   
    Ks = [1, 100, 500, 1000, 5000, 10000, 20000, 30000, 40000, 50000]

    postprocessor.plot_best_revenue_vs_K(Ks)